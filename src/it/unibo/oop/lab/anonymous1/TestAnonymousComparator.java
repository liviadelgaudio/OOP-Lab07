...
public final class TestAnonymousComparator {
    ...
    public java.util.Comparator<User> comparator(){
    ...
    public static void main(final String... args) {
         ...
         */
        Collections.sort(denzelUsers, new java.util.Comparator<User>() {
        	public int compare(User o1, User o2) {
        		return o1.getAge() - o2.getAge();
        	};
        });
         ...
         * class Collections
         */
        Collections.sort(rossiUsers, new java.util.Comparator<User>(){
        	public int compare(User o1, User o2) {
